...
def main():
    ...
    :return:
    """
    url = "https://ckan.dataplatform.nl/dataset/7498165c-c40d-459e-9f75-df5eb28c30d3/resource/341f5da0-a802-4975-8ef5-84cefd9c6dfb/download/aangifte-politie_buurten.csv"
    ...
    with ExcelWriter('data.xlsx', engine='xlsxwriter') as writer:
        df.to_excel(writer)
